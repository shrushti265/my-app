...
import {useLike, useWatchLater, useHistory, usePlaylist, useStore} from "./../../context/index"
...
const LikeCard = ({product,index}) => {
    ...
    <div class="card-footer-box card__icons">
      ...
      <MdOutlinePlaylistPlay color= "#AB542F" size="4rem" onClick={() => setOpenPlaylistModal(!openPlaylistModal)}/>
