    ...
    <>
      <div className="navbar">
        ...
        <div className="navbar_genre">
          ...
          <Link to = "/history">
            <span className="navbar_text" onClick={clickHandler}>History</span>
          </Link>

          <div className="navbar_badge">
            <Link to = "/playlist">
            <span className="navbar_text" onClick={clickHandler}>Playlist</span>
            </Link>
            <span className="navbar_badge_number navbar_text">{playlists.length}</span>
          </div>

          <div className="navbar_badge">
            <Link to ="./watchLater">
            <span className="navbar_text" onClick={clickHandler}>Watch later</span>
            </Link>
        ...
        <div className="navbar_profile_box">
          ...
          onClick={() => {
            ...
            }}}className="navbar_text">{auth.token ? "Logout" : "Login"};
          </span>
          </Link>
          </div>
        </div>
